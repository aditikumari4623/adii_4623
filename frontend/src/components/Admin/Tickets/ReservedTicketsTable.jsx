...
const ReservedTicketsTable = ({ reservedTickets, allUsers }) => {

    useLayoutEffect(() => {
        let table = new DataTable('#reservedTicketTable', {
            fixedHeader: true,
            responsive: true,
            autoWidth: true,
            paging: true,
    ...
    return (
        <>
            <section className="d-flex flex-column justify-content-between align-items-center mt-2 w-100">
                ...
                <table id="reservedTicketTable" className="table table-striped table-bordered w-100" style={{ "width": "100%" }}>
                    <thead>
                        <tr>
                            <th scope="col">#</th>
                    ...
                    <tbody>
                        {
                            reservedTickets.map((ticket, index) => {
                                ...
                                return <tr key={ticket?._id}>
                                    ...
                                    <td>
                                        {/* Share button */}
                                        <button onClick={() => shareTicket(ticket.ticketData)} type="button" className="btn btn-sm btn-primary me-1">
                                        ...
                                        {/* Download button */}
                                        <button onClick={() => downloadTicket(ticket.ticketData)} type="button" className="btn btn-sm btn-success">
...
export default ReservedTicketsTable